...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-background page-transition">
      <SEOHead
        title="Contact Us - Summerland Estates"
        description="Get in touch with Summerland Estates. We're here to help connect estate professionals with the right opportunities."
        canonical="/contact"
      />
