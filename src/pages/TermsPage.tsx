...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-background page-transition">
      <SEOHead
        title="Terms &amp; Conditions - Summerland Estates"
        description="Read the Summerland Estates Terms and Conditions governing the use of our private estate staffing network."
        canonical="/terms"
      />
      <NavBar currentPage="terms" />
