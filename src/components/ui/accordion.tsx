...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-5 text-base font-semibold transition-all duration-300 ease-in-out hover:text-[#A89F91] text-left [&[data-state=open]>svg]:rotate-180 [&[data-state=open]]:text-[#A89F91]",
        className
      )}
      {...props}
    >
